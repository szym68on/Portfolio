function IconComponent({ darkMode, setDarkMode }) {
  ...
  return (
    <>
      {darkMode ? (
        <div
          className="h-[50px] w-[50px] transition duration-300 ease-in-out hover:bg-dark-outline-variant flex items-center justify-center rounded-full"
        ...
        <div
          className="h-[50px] w-[50px] transition duration-300 ease-in-out hover:bg-light-outline-variant flex items-center justify-center rounded-full"
          onClick={changeDarkMode}
        >
          <svg
            width="30px"
